...
public class GV {
    ...
    public static Task<Void> createUser(String uid,String displayName, String email, String phoneNumber, String gender, String photo, List<String> adminIN, List<String> studentIN, List<String> teacherIN) {
        User userToCreate = new User(displayName, email, phoneNumber, gender, photo,  adminIN,studentIN,  teacherIN);
