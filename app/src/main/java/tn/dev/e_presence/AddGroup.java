        ...
        btn_ok.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(Compteur==0){
                    ...
                    String new_Category=sp_category.toString();
                    ...
                    if (NewGroup) {
                        ...
                        String timeC="Group"+System.currentTimeMillis();

                        db.collection("School").document(SchoolId).collection("Group").document(timeC)
                                .set(group)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(AddGroup.this, "Session successfully added!", Toast.LENGTH_SHORT).show();
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        Toast.makeText(AddGroup.this, "Error adding session", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                    else
                    ...
                    Toast.makeText(AddGroup.this, "Loading...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
